...
class PerplePen: UIViewController {
...
private extension PerplePen {
    
    func createTitleInfo() -> UILabel {
        let text = UILabel()
        text.text = "LAMY Special Safari Field"
    ...
    func createImagePen() -> UIImageView {
        ...
        image.image = UIImage(named: "Perple")
    ...
    func createImageBluewConstrains() {
        ...
        NSLayoutConstraint.activate([
            ...
            imagePen.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -100),
    ...
    @objc func tapButtonPerple(sender: UIView) {
        sender.tag = 0
        imagePen.image = UIImage(named: "Perple")
        setupButtons(sender: sender)
    }
    
    @objc func tapButtonRed(sender: UIView) {
        sender.tag = 1
        imagePen.image = UIImage(named: "Red")
        setupButtons(sender: sender)
    }
    
    @objc func tapButtonGreen(sender: UIView) {
        sender.tag = 2
        imagePen.image = UIImage(named: "Green")
        setupButtons(sender: sender)
    }
    ...
    @objc func tapButtonAddToCard() {
        ...
        if resultOtvet == 0 {
            ...
            let selectedPen = Pen(image: UIImage(named: "Perple")!, name: "Special Safari Field", price: "$ \(resultOtvet)")
        ...
        let alertController = UIAlertController(title: "Purchase: Special Safari Field", message: message, preferredStyle: .alert)
...
extension PerplePen: CustomButtonDelegate {
    func tap(value: Int) {
        print(value)
